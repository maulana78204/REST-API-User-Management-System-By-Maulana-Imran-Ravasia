...
import com.example.usermanagement.security.SecurityUtils;
...
public class OAuth2TestUtil {
    ...
    public static OAuth2AuthenticationToken registerAuthenticationToken(OAuth2AuthorizedClientService authorizedClientService, ClientRegistration clientRegistration, OAuth2AuthenticationToken authentication) {
